...
class TermsNamesPeriodDocFilter( AbstractDocFilter ):
    ...
    def filter( self, query_analyzed:QueryAnalyzedType|None=None, names:list[str]|None=None, period:str|None=None ) -> list[str]:
        ...
        names_filtered_doc = list( set( [ t.split('.')[0] for t in self.namesFilter.tags ] ) ) # e.g. tags -> '234.0', '234.1', '235.0', ...
        if names:
            single_results = []
            for name in names: 
...
def docFilterFactory( option:str ):
    ...
    match option:
        ...
        case 'arxiv-lemm-single':
            ...
            return TermsNamesPeriodDocFilter( termsFilter=termsFilter, namesFilter=namesFilter, periodFilter=periodFilter )
        ...
        case 'medical-lemm-single':
            ...
            return TermsDocFilter( termsFilter=termsFilter )
